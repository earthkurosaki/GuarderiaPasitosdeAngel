...
--
-- Table structure for table `empleado_nomina`
--
...
CREATE TABLE `empleado_nomina` (
  ...
  CONSTRAINT `empleado_nomina_ibfk_1` FOREIGN KEY (`id_empleados`) REFERENCES `empleados` (`id_empleados`),
  CONSTRAINT `empleado_nomina_ibfk_2` FOREIGN KEY (`id_nomina`) REFERENCES `nomina` (`id_nomina`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `empleado_nomina`
--

LOCK TABLES `empleado_nomina` WRITE;
/*!40000 ALTER TABLE `empleado_nomina` DISABLE KEYS */;
/*!40000 ALTER TABLE `empleado_nomina` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `nomina` (
  ...
  `afp` decimal(10,0) NOT NULL,
  `ars` decimal(10,0) NOT NULL,
...
-- Dump completed on 2024-05-08  8:23:35
