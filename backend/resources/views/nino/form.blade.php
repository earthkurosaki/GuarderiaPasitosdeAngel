<x-app-layout>
    <div class="sm:flex-auto bg-white p-6 rounded-lg shadow-md">
        <h1 class="text-2xl font-bold leading-tight text-gray-900">{{ __('Niños') }}</h1>
        <p class="mt-2 text-md text-gray-600">Una lista de todos los {{ __('Niños') }}.</p>
    </div>
    <div class="py-12">
                    ...
                    <form method="GET" action="{{route('nino.store')}}">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" placeholder="Nombre" name="nombre" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-black">Apellido</label>
                                <input type="text" placeholder="Apellido" name="apellido" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-black">Fecha de nacimiento</label>
                                <input type="date" placeholder="Fecha de nacimiento" name="fecha_nac" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-black">Edad</label>
                                <input type="number" placeholder="Edad" name="edad" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Nacionalidad" name="nacionalidad" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" placeholder="Cantidad de hermanos" name="cant_hermanos" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-black">Nivel educativo</label>
                                <input type="text" placeholder="Nivel educativo" name="niv_educativo" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Descripción de alergia" name="desc_alergia" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Descripción de discapacidad" name="desc_discapacidad" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>
