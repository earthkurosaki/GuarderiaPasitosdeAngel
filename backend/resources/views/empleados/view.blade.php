        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="w-full">
                    ...
                    <form method="GET" action="{{ route('View_Empleado') }}" class="mb-4 flex items-center space-x-2">
                        ...
                        @if ($search)
                            <a href="{{ route('View_Empleado') }}" class="bg-gray-500 text-white px-4 py-2 rounded flex items-center space-x-2">
