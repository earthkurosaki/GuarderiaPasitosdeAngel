                    ...
                    <form method="POST" action="{{ route('empleados.update', ['id_empleados' => $empleado->id_empleados]) }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="number" placeholder="Cédula" name="cedula" id="cedula-{{ $empleado->id_empleados }}" value="{{ $empleado->cedula}}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" placeholder="Teléfono" name="telefono" id="telefono-{{ $empleado->id_empleados }}" value="{{ $empleado->telefono }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" placeholder="Teléfono de Emergencia" name="teleemergencia" id="teleemergencia-{{ $empleado->id_empleados }}" value="{{ $empleado->teleemergencia }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-black">Puesto</label>
                                <input type="number" placeholder="Puesto" name="id_puesto" id="id_puesto-{{ $empleado->id_empleados }}" value="{{ $empleado->id_puesto }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"/>
                            </div>
