                ...
                @if (Route::has('login'))
                    @auth
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button
                                class="bg-[#00b5ec] text-white px-3 py-2 rounded-full hover:bg-[#1696e4] text-sm font-semibold">
                                Cerrar sesión
                            </button>
                        </form>
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="inline-block">
                                <button
                                    class="bg-[#00b5ec] text-white px-3 py-2 rounded-full hover:bg-[#1696e4] text-sm font-semibold mx-1">
                                    Regístrate
                                </button>
                            </a>
                        @endif
                ...
                <div class="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-24 max-w-7xl">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="p-6 shadow-card">
                            ...
                            <p class="mx-auto text-base leading-relaxed text-black">
                                Estamos emocionados de anunciarte que próximamente estaremos ofreciendo una variedad de
                                nuevos servicios
                                diseñados para enriquecer la experiencia de aprendizaje y diversión de tus hijos.
    ...
    <div class="pp">
        <section class="aa text-gray-600 body-font relative" id="contact">
            <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                <div class="lg:w-2/3 md:w-11/12 mx-auto bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    ...
                    <div class="relative bg-white flex flex-col sm:flex-row flex-wrap py-6 rounded shadow-md z-10 w-full sm:w-auto sm:min-w-[300px] mx-auto">
                        ...
                        <div class="w-full sm:w-1/2 px-6 mt-4 sm:mt-0">
                            ...
                            <a class="block text-blue-500 break-words leading-relaxed">pasitosdaycare01021315@gmail.com</a>
